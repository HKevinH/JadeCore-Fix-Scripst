...
enum eCreaturesLocal
{
    ...
    // Galakras
    BOSS_GALAKRAS = 72249,
    CREATURE_MASTER_CANNONEER_DAGRYN = 72356,
    CREATURE_HIGH_ENFORCER_THRANOK = 72355,
    CREATURE_LIEUTENANT_KRUGRUK = 72357,
    CREATURE_KORGRA_THE_SNAKE = 72456,
    CREATURE_DRAGONMAW_BONECRUSHER = 72354,
    ...
    CREATURE_SETTHIK_WIELDER = 71405,
    CREATURE_ANIMATED_STONE_MOGU = 71380,
    CREATURE_BURIAL_URN = 71382,
    CREATURE_QUILEN_GARDIANS = 72223,
    CREATURE_SRITHIK_BOMBARDIER = 71385,
    CREATURE_KORTHIK_WARCALLER = 62754,
    CREATURE_ANCIENT_BREWMASTER_SPIRIT = 71427, // Unknown coordinates
    CREATURE_WISE_MISTEWEAVER_SPIRIT = 71428, // Unknown coordinates
    CREATURE_NAMELESSE_WINDWALLKER_SPIRIT = 71430, // Unknown coordinates
